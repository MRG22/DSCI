...
from modules.dataloaders_all import R2DataLoader
...
def parse_agrs():
    ...
    parser.add_argument('--ann_path', type=str, default='./data/mimic/ann_mimic_tags.json', help='the path to the directory containing the data.')
    ...
    parser.add_argument('--save_dir', type=str, default='results/mimic_cxr/522/', help='the patch to save the models.')
    parser.add_argument('--record_dir', type=str, default='records/mimic_cxr/522/', help='the patch to save the results of experiments')
    ...
    parser.add_argument('--load', type=str, default='./results/mimic/model_best.pth', help='whether to load a pre-trained model.')
