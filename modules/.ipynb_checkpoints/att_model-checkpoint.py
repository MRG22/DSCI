...
class AttModel(CaptionModel):
    ...
    def get_logprobs_state(self, it, fc_feats, att_feats, p_att_feats, att_masks, state, output_logsoftmax=1, tags=None):
    ...
    def _sample_beam(self, fc_feats, att_feats, att_masks=None,  opt={}, tags=None):
        ...
        p_fc_feats, p_att_feats, pp_att_feats, p_att_masks = self._prepare_feature(fc_feats, att_feats, att_masks, tags)
        ...
        logprobs, state = self.get_logprobs_state(it, p_fc_feats, p_att_feats, pp_att_feats, p_att_masks, state, tags=tags)
    ...
    def _sample(self, fc_feats, att_feats, att_masks=None, tags=None):#这里的tag应是预测的tag
        ...
        if beam_size > 1 and sample_method in ['greedy', 'beam_search']:
            return self._sample_beam(fc_feats, att_feats, att_masks, opt, tags=tags)
        if group_size > 1:
